...
git clone https://github.com/YOUR\_USERNAME/cyber-hr-skill .claude/skills/create-cyber-hr
...
├── prompts/
│   ├── intake.md
│   ├── hr\_memory\_analyzer.md
│   ├── hr\_persona\_analyzer.md
│   ├── hr\_memory\_builder.md
│   ├── hr\_persona\_builder.md
│   ├── merger.md
│   └── correction\_handler.md
├── tools/
│   ├── wechat\_parser.py
│   ├── qq\_parser.py
│   ├── social\_parser.py
